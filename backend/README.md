...
**1.345 pruebas automáticas** en total (`python manage.py test` → OK). La HU-17 no
...
```bash
python manage.py test                                 # 1.345 pruebas
...
python manage.py test fichas                          # HU-07 a HU-18 (799)
```
